...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, AsyncResponse {
    ...
    private static final int ASK_MULTIPLE_PERMISSION_REQUEST_CODE = 1990;
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "salil@gmail.com:mca1132", "bar@example.com:world", "user@resultstrack.in:password",
            "admin@resultstrack.in:helpmenot"
    };
    /**
        ...
        if (shouldShowRequestPermissionRationale(READ_CONTACTS)) {
            Snackbar.make(mEmailView, R.string.permission_rationale, Snackbar.LENGTH_INDEFINITE)
                    .setAction(android.R.string.ok, new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            requestPermissions(new String[]{READ_CONTACTS,CAMERA,WRITE_EXTERNAL_STORAGE,
                            ACCESS_FINE_LOCATION,ACCESS_COARSE_LOCATION,ACCESS_NETWORK_STATE}, ASK_MULTIPLE_PERMISSION_REQUEST_CODE);
                        }
                    });
        } else {
    ...
    public void backButtonHandler() {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(
                LoginActivity.this,R.style.datepicker);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            try {
                ...
                //Thread.sleep(2000);
                appUser user = appUser.getUser(mEmail);
                if (user != null) {
                    return user.getPaswrd().equals(mPassword);
                } else {
                    Intent signupIntent = new Intent(LoginActivity.this, SignupActivity.class);
                    LoginActivity.this.startActivity(signupIntent);
                    finish();
